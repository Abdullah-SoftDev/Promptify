...
const page = () => {
  ...
  const getUserProfile = async (uid: string | null) => {
  ...
  <h1 className='text-5xl text-center font-bold pt-14 max-w-6xl mx-auto'>
        <span className='bg-gradient-to-r from-purple-500 via-pink-600 to-rose-500 bg-clip-text text-transparent text-center'>{profileData[0]?.creatorName} profile feed
</span>
      </h1>
