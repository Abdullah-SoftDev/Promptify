...
const Promptcard = (post: PostsPromps) => {
    return (
        <>
          <article className="flex flex-col items-start justify-between bg-gray-100 p-3 border border-gray-200 rounded-md">
    ...
    <div className="group relative">
        <p className="mt-5 font-medium text-sm leading-6 text-gray-600">{post.description}</p>
    </div>
